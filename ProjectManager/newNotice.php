		...
		<div class="w3-right w3-panel" style="width:85%">
			...
			<div class="w3-section">
				...
				<div class="w3-card-4">
					...
					<form class="w3-container" method="post" name="newPost" action="newNoticeServer.php" onsubmit="return validateForm();">
						...
						<input type="text" name="description" class="w3-input" id="i2" required>
						<p class="w3-xsmall w3-red" name="descriptionValidation"></p>

						<input type="submit" class="w3-btn w3-block w3-teal w3-hover-green" value="Post">
					</form>
				</div>
			</div>
		</div>
