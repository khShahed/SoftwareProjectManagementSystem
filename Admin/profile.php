					...
					<div class="w3-modal-content">
						...
						<form method="post" action="changePassword.php" name="myForm" onsubmit="return validateForm()">
							<div class="w3-container">
								...
								<input type="password" class="w3-input" name="currentPassword" id="cp">
								<span id="cpError"></span> <br>
								<label for=""> New Password :</label>
								<input type="password" class="w3-input" name="newPassword" id="np">
								<label for="">Retype Password :</label>
								<input type="password" class="w3-input" name="retypePassword" id="rp">
							</div>
							<footer class="w3-container w3-teal">
